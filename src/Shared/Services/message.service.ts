...
import { Group, MessageDTO, MessageType } from '../Models/chat.model';
...
export class MessageService {
    ...
    public getMessages(senderId: number, recipientId: string, messageType: MessageType): Observable<MessageDTO[]> {
    ...
    public getGroups(userId: number): Observable<Group[]> {
        const params = new HttpParams().set('userId', userId.toString());
